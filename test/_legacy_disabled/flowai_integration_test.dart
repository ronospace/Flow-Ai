...
import 'package:flow_ai/core/services/flowai_service.dart';
import 'package:flow_ai/core/config/flowai_config.dart';
...
void main() {
  ...
  group('Flow Ai Configuration Tests', () {
    ...
    test('should return correct model configurations', () {
      ...
      final insightsConfig = FlowAIConfig.getModelConfig(
        FlowAIUseCase.insights,
      );
