...
class PartnerCareActionsWidget extends StatefulWidget {
  ...
  @override
  State<PartnerCareActionsWidget> createState() =>
      _PartnerCareActionsWidgetState();
}
  ...
  Widget _buildCareHistory(ThemeData theme) {
    if (widget.careActions.isEmpty) {
      return Container(
        ...
        child: Column(
          children: [
            Icon(Icons.history, size: 48, color: AppTheme.lightGrey),
            const SizedBox(height: 16),
            Text(
              'No care actions yet',
              style: theme.textTheme.titleMedium?.copyWith(
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                'Last 7 days',
                style: TextStyle(color: AppTheme.lightGrey, fontSize: 10),
              ),
            ],
          ),
          const SizedBox(height: 16),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 40,
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: actionInfo['gradient']),
              borderRadius: BorderRadius.circular(12),
            ),
            child: Center(
              child: Text(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Text(
                      action.senderId == widget.currentUserId
                          ? 'You sent'
                          : 'Received',
                      style: TextStyle(
                        fontWeight: FontWeight.w600,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                  borderSide: BorderSide(color: actionInfo['color'], width: 2),
                ),
              ),
              maxLines: 3,
              maxLength: 200,
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              final defaultDesc = _getDefaultMessage(
                actionInfo['type'] as CareActionType,
              );
