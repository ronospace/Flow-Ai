...
import '../../insights/widgets/floating_ai_chat.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          const FloatingAIChat(heroTag: 'home_ai_chat_fab'),
          ...
          GridView.count(
            ...
            children: [
              ...
              _buildHealthMetricCard(
                ...
                provider.predictions?.currentPhase.displayName ??
                ...
                .map(
                  (insight) =>
                      Container(
                          ...
                          .fadeIn(
                            delay:
                                (600 + provider.insights.indexOf(insight) * 200)
                                    .ms,
                          )
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            theme.cardColor,
            AppTheme.warningOrange.withValues(alpha: 0.04),
          ],
        ),
        borderRadius: BorderRadius.circular(24),
        border: Border.all(
...
extension _NavigationMethods on _HomeScreenState {
  ...
  void _navigateToAIPredictions() {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (context) => const AIPredictionsScreen()),
    );
  }

  void _navigateToHealthcarePortal() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => const HealthcareProviderPortalScreen(),
      ),
    );
  }
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (points.isNotEmpty) {
      ...
      for (int i = 1; i < points.length; i++) {
        ...
        final animatedX =
            points[0].dx + (currentPoint.dx - points[0].dx) * animation;
        final animatedY =
