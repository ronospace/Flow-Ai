...
class AppEnhancements {
  ...
  static Widget buildEnhancedButton({
    ...
    ).animate().scale(delay: 100.ms, duration: 200.ms).fadeIn(duration: 300.ms);
  }
      ...
      children: [
        Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: AppTheme.warningOrange, width: 3),
              ),
              child: Icon(
                Icons.close_rounded,
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: prefixIcon != null
              ? Icon(prefixIcon, color: AppTheme.mediumGrey)
              : null,
