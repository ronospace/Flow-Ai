    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.star_rounded, color: AppTheme.primaryPurple, size: 18),
  ...
  Widget _buildEstimatedDate(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.schedule_rounded, color: AppTheme.accentMint, size: 18),
...
class ComingSoonWidgets {
  ...
  static Widget aiCoach(BuildContext context, {VoidCallback? onNotifyMe}) {
    return ComingSoonWidget(
      ...
      description:
          'Get personalized insights and recommendations powered by advanced AI algorithms that learn from your cycle patterns, symptoms, and lifestyle data.',
  ...
  static Widget partnerFeatures(
    ...
    return ComingSoonWidget(
      ...
      description:
          'Connect with your partner to share important cycle information and get support when you need it most.',
  ...
  static Widget premiumAnalytics(
    ...
    return ComingSoonWidget(
      ...
      description:
          'Unlock deeper insights with advanced data visualization and predictive modeling for your reproductive health.',
