...
- **In-App**: Use the Delete Account control available in Settings.
...
### Services We Use:
- **Firebase (Google)**: Authentication and explicitly enabled connected services. Processing locations depend on the configured Firebase services.
  - Privacy Policy: https://firebase.google.com/support/privacy
- **Apple HealthKit**: Biometric data integration (iOS only)
  - Privacy Policy: https://www.apple.com/legal/privacy/
- **Google AdMob**: The SDK is included, but advertising is disabled in the current production release. Health data is not used for advertising.
  - Privacy Policy: https://support.google.com/admob/answer/6128543

### AI and Machine Learning:
- AI predictions and health insights run locally in the current production release.
- Optional external AI code paths remain inactive unless a future release is explicitly configured to use them.
...
3. Using the Delete Account control available in Settings
