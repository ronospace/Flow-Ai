#!/usr/bin/env dart
// Script to generate all 36 language ARB files for Flow iQ
// Run with: dart generate_languages.dart

import 'dart:io';
import 'dart:convert';

// The 36 languages Flow iQ supports
final Map<String, Map<String, String>> languageTranslations = {
  ...
  'hi': { // Hindi
    ...
    'insights': 'इनसाइट्स',
    'settings': 'सेटिंग्स',
    'welcome': 'Flow iQ में आपका स्वागत है',
  ...
  'ru': { // Russian
    ...
    'insights': 'Аналитика',
    'settings': 'Настройки',
    'welcome': 'Добро пожаловать в Flow iQ',
    'getStarted': 'Начать',
    'yes': 'Да',
    'no': 'Нет',
    'save': 'Сохранить',
  ...
  'de': { // German
    ...
    'welcome': 'Willkommen bei Flow iQ',
    'getStarted': 'Loslegen',
    'yes': 'Ja',
    'no': 'Nein',
    'save': 'Speichern',
  ...
  'tr': { // Turkish
    ...
    'insights': 'Görüşler',
    'settings': 'Ayarlar',
    'welcome': 'Flow iQ\'e Hoş Geldiniz',
    'getStarted': 'Başlayın',
    'yes': 'Evet',
    'no': 'Hayır',
    'save': 'Kaydet',
  ...
  'vi': { // Vietnamese
    ...
    'insights': 'Thông tin',
    'settings': 'Cài đặt',
    'welcome': 'Chào mừng đến với Flow iQ',
    'getStarted': 'Bắt đầu',
    'yes': 'Có',
    'no': 'Không',
    'save': 'Lưu',
  ...
  'th': { // Thai
    ...
    'settings': 'การตั้งค่า',
    'welcome': 'ยินดีต้อนรับสู่ Flow iQ',
    'getStarted': 'เริ่มต้น',
    'yes': 'ใช่',
    'no': 'ไม่',
    'save': 'บันทึก',
  ...
  'sv': { // Swedish
    ...
    'welcome': 'Välkommen till Flow iQ',
  ...
  'he': { // Hebrew
    ...
    'insights': 'תובנות',
    'settings': 'הגדרות',
    'welcome': 'ברוכים הבאים ל-Flow iQ',
    'getStarted': 'התחלה',
    'yes': 'כן',
    'no': 'לא',
    'save': 'שמור',
  ...
  'hu': { // Hungarian
    ...
    'welcome': 'Üdvözöljük a Flow iQ-ben',
    'getStarted': 'Kezdés',
    'yes': 'Igen',
    'no': 'Nem',
    'save': 'Mentés',
  ...
  'uk': { // Ukrainian
    ...
    'welcome': 'Ласкаво просимо до Flow iQ',
    'getStarted': 'Почати',
    'yes': 'Так',
    'no': 'Ні',
    'save': 'Зберегти',
  ...
  'el': { // Greek
    ...
    'insights': 'Γνώσεις',
    'settings': 'Ρυθμίσεις',
    'welcome': 'Καλώς ήρθατε στο Flow iQ',
  ...
  'bg': { // Bulgarian
    ...
    'insights': 'Прозрения',
    'settings': 'Настройки',
    'welcome': 'Добре дошли във Flow iQ',
  ...
  'ro': { // Romanian
    ...
    'settings': 'Setări',
    'welcome': 'Bine ați venit la Flow iQ',
    'getStarted': 'Începeți',
    'yes': 'Da',
    'no': 'Nu',
    'save': 'Salvați',
  ...
  'lt': { // Lithuanian
    ...
    'insights': 'Įžvalgos',
    'settings': 'Nustatymai',
    'welcome': 'Sveiki atvykę į Flow iQ',
    'getStarted': 'Pradėti',
    'yes': 'Taip',
    'no': 'Ne',
    'save': 'Išsaugoti',
  ...
  'et': { // Estonian
    ...
    'insights': 'Teadmised',
    'settings': 'Seaded',
    'welcome': 'Tere tulemast Flow iQ\'i',
    'getStarted': 'Alusta',
    'yes': 'Jah',
    'no': 'Ei',
    'save': 'Salvesta',
...
void main() async {
  print('🌍 Generating 36 language ARB files for Flow iQ...\n');
